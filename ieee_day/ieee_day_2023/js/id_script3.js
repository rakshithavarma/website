...
function purchaseClicked() {
  ...
  // }
if(total1>=300){
      val1 = '₹' + Math.round(total1 * 70) / 100 
  } 
  else {
     val1 = '₹' + Math.round(total1 * 100) / 100            
  }
  if(total2>=300){
      val2 = '₹' + Math.round(total2 * 60) / 100 
  } 
  else {
  val2 = '₹' + Math.round(total2 * 100) / 100 
}
...
function updateCartTotal() {
  ...
  if(total1>=300){
      document.getElementsByClassName('cart-total-price')[2].innerText = '₹' + Math.round(total1 * 70) / 100 
      document.getElementsByClassName('cart-total-price')[0].innerText = '₹' + Math.round(total1 * 30) / 100 
  } 
  else {
...
if(total2>=300){
      document.getElementsByClassName('cart-total-price')[3].innerText = '₹'+ Math.round(total2 * 60) / 100
      document.getElementsByClassName('cart-total-price')[1].innerText = '₹'+ Math.round(total2 * 40) / 100
  } 
  else {
